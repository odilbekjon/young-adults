const Achievements = () => {
  return (
    <div className="w-full bg-white text-[#333] text-[1.1rem] py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-20">
        {/* Investitsiya va Sharoitlar */}
        <section className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center text-[#023e8a]">
            Investitsiya va Sharoitlar
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <ul className="list-disc pl-6 space-y-4 text-xl marker:text-[#f77f00]">
              ...
              <li>Xitoydan 5000$ qiymatida asbob uskunalar olib kelindi.</li>
        ...
        <section className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center text-[#023e8a]">
            IELTS va O'sish Ko'rsatkichlari
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-10 text-center text-[#023e8a]">
            Xorijdagi Nufuzli Universitetlar
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            <ul className="list-disc pl-6 space-y-4 text-xl marker:text-[#f77f00]">
        ...
        <section className="mb-16 bg-[#fffdf6] p-8 rounded-xl shadow-lg">
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-center text-[#023e8a]">
            Kelajakdagi Rejalar
          </h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
